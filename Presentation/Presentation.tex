...
%{
%\begin{itemize}
%\item Nutzer-Klassifizierung (Customer / Subscriber)
%\end{itemize}
%}
%}
...
\myBlock[1]{Arbeitstage versus Ferien}
{
\begin{itemize}
...
%\begin{columns}
%\begin{column}{0.5\textwidth}
%\includegraphics[width=\textwidth]{../Images/Tripduration}
%\end{column}
%\begin{column}{0.5\textwidth}
\centering
...
%\end{column}
%\begin{column}{0.5\linewidth}
%\myBlock[1]{Evaluation}
%{
%\begin{itemize}
%\item Baseline: 89\% Genauigkeit
%\item Confusion-Matrix
%\item Mathews Correlation Coefficient
%\end{itemize}
%}
%\myBlock[1]{Training}
%{
%\begin{itemize}
%\item Kostenfunktion gewichten
%\end{itemize}
%}
%\end{column}
%\end{columns}
...
\myBlock[1]{Splitting versus Cross-Validation}
{
\begin{itemize}
...
\begin{frame}
\begin{beamercolorbox}[sep=8pt,center]{title}
    \usebeamerfont{title}{Analyse der Training Daten}
\end{beamercolorbox}
\end{frame}
...
\begin{frame}
\begin{beamercolorbox}[sep=8pt,center]{title}
    \usebeamerfont{title}{Modell Training und Auswahl}
\end{beamercolorbox}
\end{frame}
...
\highlight{Interaktionen}: Tageszeit x Arbeitstag, Start- x End-Station
...
\includegraphics[width=\textwidth]{Bilder/GridSearchMCC} 
\end{column}
...
\begin{frame}
\begin{beamercolorbox}[sep=8pt,center]{title}
    \usebeamerfont{title}{Kooperation mit einer Versicherung}
\end{beamercolorbox}
\end{frame}
